/**
 * Блок краткой биографии: заголовок «Обо мне» и один или несколько абзацев.
 * Стили изолированы CSS-модулем AboutMe.module.css (имена классов хешируются при сборке).
 */
